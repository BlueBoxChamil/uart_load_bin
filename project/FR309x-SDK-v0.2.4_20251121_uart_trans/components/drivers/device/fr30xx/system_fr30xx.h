...
typedef struct
{
    ...
    uint32_t SPLL_CLKCDC_DIV2_EN : 1;
...
typedef struct
{
    ...
    uint32_t PARALLEL_CLK_SEL  : 2;
    uint32_t GPIO_CLK_SEL      : 1;
    uint32_t UART_CLK_SEL      : 1;
    uint32_t I2C_CLK_SEL       : 1;
    uint32_t IIRFLT_CLK_SEL    : 1;
    uint32_t TRIGFUNC_CLK_SEL  : 1;
    uint32_t FFT_CLK_SEL       : 1;
    uint32_t SSIM_CLK_SEL      : 1;
    uint32_t BLEND_CLK_SEL     : 1;
    uint32_t MCAN_CLK_SEL      : 1;
    uint32_t rsv_1             : 3;    
}REG_BLOCKCLK_SEL_t;
...
typedef struct
{
    ...
    uint32_t PDM2_CLK_SEL      : 2;
    uint32_t SBC_CLK_SEL       : 1;
    uint32_t rsv_0             : 21;    
}REG_AUDIOCLK_SEL_t;
...
typedef struct
{
    uint32_t PARALLEL_CLK_DIV  : 4;
    uint32_t GPIO_CLK_DIV      : 4;
    uint32_t UART_CLK_DIV      : 4;
    uint32_t I2C_CLK_DIV       : 4;
    uint32_t IIRFLT_CLK_DIV    : 4;
    uint32_t TRIGFUNC_CLK_DIV  : 4;
    uint32_t FFT_CLK_DIV       : 4;
    uint32_t SSIM_CLK_DIV      : 4;
}REG_BLOCKCLK_DIV1_t;

/* Block Clock Divider control2 Register */
typedef struct
{
    uint32_t BLEND_CLK_DIV     : 4;
    uint32_t MCAN_CLK_DIV      : 4;
    uint32_t PWM_CLK_DIV       : 4;
    uint32_t FRSPIM_CLK_DIV    : 4;
    uint32_t USB_CLK_DIV       : 4;
...
typedef struct
{
    ...
    uint32_t PDM2_CLK_DIV      : 4;
    uint32_t SBC_CLK_DIV       : 4;
    uint32_t rsv_0             : 8;    
}REG_AUDIOCLK_DIV_t;
...
typedef struct
{
    ...
    uint32_t I2C3_CLKEN   : 1;
    uint32_t I2C4_CLKEN   : 1;  
    uint32_t I2C5_CLKEN   : 1; 
    uint32_t rsv_0        : 20;
}REG_CLK_EN5_t;
...
typedef struct
{
    uint32_t SEC_CLKEN     : 1;
    uint32_t SHA_CLKEN     : 1;
    uint32_t RSA_CLKEN     : 1;
    uint32_t AES_CLKEN     : 1;
    uint32_t IIRFLT_CLKEN  : 1;
    uint32_t TRIGFUNC_CLKEN: 1;
    uint32_t FFT_CLKEN     : 1;
    uint32_t TRNG_CLKEN    : 1;
    uint32_t CRC_CLKEN     : 1;
    uint32_t BLEND_CLKEN   : 1;
...
typedef struct
{
    ...
    uint32_t I2S2_CLKEN     : 1;
    uint32_t PDM0_CLKEN     : 1;   
    uint32_t PDM1_CLKEN     : 1; 
    uint32_t PDM2_CLKEN     : 1; 
    uint32_t CODEC_CLKEN    : 1;
    uint32_t SBCDEC_CLKEN   : 1;
    uint32_t SBCENC_HCLKEN  : 1;
    uint32_t MP3D_CLKEN     : 1;
    uint32_t rsv_0          : 21;
}REG_CLK_EN8_t;
...
typedef struct
{
    ...
    uint32_t I2C3_SFT_RST   : 1; 
    uint32_t I2C4_SFT_RST   : 1;  
    uint32_t I2C5_SFT_RST   : 1;     
    uint32_t rsv_0          : 20;
}REG_RESET5_t;
...
typedef struct
{
    uint32_t SEC_SFT_RST     : 1;
    uint32_t SHA_SFT_RST     : 1;
    uint32_t RSA_SFT_RST     : 1;
    uint32_t AES_SFT_RST     : 1;
    uint32_t IIRFLT_SFT_RST  : 1;
    uint32_t TRIGFUNC_SFT_RST: 1; 
    uint32_t FFT_SFT_RST     : 1;
    uint32_t TRNG_SFT_RST    : 1; 
    uint32_t CRC_SFT_RST     : 1; 
    uint32_t BLEND_SFT_RST   : 1; 
...
typedef struct
{
    ...
    uint32_t I2S2_SFT_RST   : 1;
    uint32_t PDM0_SFT_RST   : 1;
    uint32_t PDM1_SFT_RST   : 1; 
    uint32_t PDM2_SFT_RST   : 1;
    uint32_t CODEC_SFT_RST  : 1; 
    uint32_t SBCDEC_SFT_RST : 1; 
    uint32_t SBCENC_SFT_RST : 1;     
    uint32_t rsv_0          : 22;
}REG_RESET8_t;
...
typedef struct
{
    volatile uint32_t           QSPI_InputEN;
    volatile uint32_t           QSPI_PullEN;
    volatile uint32_t           QSPI_PullSelect;
    volatile uint32_t           QSPI_PullResCfg;
...
typedef struct
{
    volatile uint32_t           OSPI_InputEN;
    volatile uint32_t           OSPI_PullEN;
    volatile uint32_t           OSPI_PullSelect;
    volatile uint32_t           OSPI_PullResCfg;
...
typedef struct
{
    ...
    uint32_t rsv_0           : 1;
    uint32_t SDIOH1_CD_N     : 1;
    uint32_t SDIOH1_WP       : 1;
    uint32_t SDIOH1_DAT_SWAP : 1;
    uint32_t rsv_1           : 25;
}REG_SDIOH_MISC_t;
...
typedef struct
{
    ...
    volatile uint32_t                 PortA_InputCutoffDisable;   /* Offset 0x80 */
    volatile uint32_t                 PortB_InputCutoffDisable;   /* Offset 0x84 */
    volatile uint32_t                 PortC_InputCutoffDisable;   /* Offset 0x88 */
    volatile uint32_t                 PortD_InputCutoffDisable;   /* Offset 0x8C */ 
    volatile uint32_t                 rsv_1[4];   
    ...
    volatile uint32_t                 rsv_3[4];                   
                                                                  
    volatile uint32_t                 PortA_PullResCfg;           /* Offset 0xE0 */
    volatile uint32_t                 PortB_PullResCfg;           /* Offset 0xE4 */
    volatile uint32_t                 PortC_PullResCfg;           /* Offset 0xE8 */
    volatile uint32_t                 PortD_PullResCfg;           /* Offset 0xEC */
    volatile uint32_t                 rsv_4[4];                   
    ...
    volatile uint32_t                 rsv_6[8];                   
                                                                  
    volatile uint32_t                 PortA_Monitor;              /* Offset 0x160 */
    volatile uint32_t                 PortB_Monitor;              /* Offset 0x164 */
    volatile uint32_t                 PortC_Monitor;              /* Offset 0x168 */
    volatile uint32_t                 PortD_Monitor;              /* Offset 0x16C */
    volatile uint32_t                 rsv_7[4];                   
    ...
    volatile uint32_t                 rsv_11[24];                 
                                                                  
    volatile uint32_t                 DmacHsCfg[0xF];             /* Offset 0x2C0 */

    volatile uint32_t                 rsv_12[0x11];
}struct_System_t;
...
/* peripheral clock inquire index */
typedef enum
{
...
typedef struct
{
    ...
    uint32_t APB3_DIV;    /* This parameter can be a value 1 ~ 4 */
}System_ClkConfig_t;
...
#define __SYSTEM_AUPLL_CLK_DIV2_ENABLE()               (SYSTEM->ClockCTRL.SPLL_CLKCDC_DIV2_EN = 1)
#define __SYSTEM_SPLL_CLK_DIV2_ENABLE()                (SYSTEM->ClockCTRL.SPLL_CLK_DIV2_EN    = 1)
#define __SYSTEM_SPLL_CLK_CDC_DIV2_ENABLE()            (SYSTEM->ClockCTRL.SPLL_CLKCDC_DIV2_EN = 1)
...
#define __SYSTEM_APB3_CLK_RATIO(__RATIO__)             (SYSTEM->BusClockDIV.APB3_RATIO  = __RATIO__ - 1)
#define __SYSTEM_MCU_CLK_DIV(__CLKDIV__)               (SYSTEM->BusClockDIV.MCU_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_LIBRARY_ROM_CLK_ENABLE()              (SYSTEM->ClockEnable0.LIB_ROM_CLKEN = 1)
...
#define __SYSTEM_BOOT_ROM_CLK_DISABLE()                (SYSTEM->ClockEnable0.BOOT_ROM_CLKEN= 0)
...
/* ======================================================================================================= */
/* =============================== RSA Clock Enable/Disable ============================================== */
/* ======================================================================================================= */
#define __SYSTEM_RSA_CLK_ENABLE()                       (SYSTEM->ClockEnable7.RSA_CLKEN = 1)
#define __SYSTEM_RSA_CLK_DISABLE()                      (SYSTEM->ClockEnable7.RSA_CLKEN = 0)

#define __SYSTEM_RSA_RESET()                            (SYSTEM->RegReset7.RSA_SFT_RST  = 1)

/* ======================================================================================================= */
/* =============================== SHA Clock Enable/Disable ============================================== */
/* ======================================================================================================= */
#define __SYSTEM_SHA_CLK_ENABLE()                       (SYSTEM->ClockEnable7.SHA_CLKEN = 1)
#define __SYSTEM_SHA_CLK_DISABLE()                      (SYSTEM->ClockEnable7.SHA_CLKEN = 0)

#define __SYSTEM_SHA_RESET()                            (SYSTEM->RegReset7.SHA_SFT_RST  = 1)

/* ======================================================================================================= */
/* =============================== SEC Clock Enable/Disable ============================================== */
/* ======================================================================================================= */
#define __SYSTEM_SEC_CLK_ENABLE()                       (SYSTEM->ClockEnable7.SEC_CLKEN = 1)
#define __SYSTEM_SEC_CLK_DISABLE()                      (SYSTEM->ClockEnable7.SEC_CLKEN = 0)

#define __SYSTEM_SEC_RESET()                            (SYSTEM->RegReset7.SEC_SFT_RST  = 1)
...
#define __SYSTEM_SDIOH1_CLK_SELECT_COREH()              (SYSTEM->ClockSEL0.SDIOH1_CLK_SEL = 0)
#define __SYSTEM_SDIOH1_CLK_SELECT_SPLL()               (SYSTEM->ClockSEL0.SDIOH1_CLK_SEL = 1)
#define __SYSTEM_SDIOH1_CLK_SELECT_AUPLL()              (SYSTEM->ClockSEL0.SDIOH1_CLK_SEL = 2)

#define __SYSTEM_SDIOH0_CLK_DIV(__CLKDIV__)             (SYSTEM->BlockClockDIV0.SDIOH0_CLK_DIV = __CLKDIV__ - 1)
#define __SYSTEM_SDIOH1_CLK_DIV(__CLKDIV__)             (SYSTEM->BlockClockDIV0.SDIOH1_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_SDIOH0_CLK_ENABLE()                    (SYSTEM->ClockEnable2.SDIOH0_CLKEN = 1)
#define __SYSTEM_SDIOH1_CLK_ENABLE()                    (SYSTEM->ClockEnable2.SDIOH1_CLKEN = 1)
#define __SYSTEM_SDIOH0_CLK_DISABLE()                   (SYSTEM->ClockEnable2.SDIOH0_CLKEN = 0)
#define __SYSTEM_SDIOH1_CLK_DISABLE()                   (SYSTEM->ClockEnable2.SDIOH1_CLKEN = 0)

#define __SYSTEM_SDIOH0_RESET()                         (SYSTEM->RegReset2.SDIOH0_SFT_RST = 1)
#define __SYSTEM_SDIOH1_RESET()                         (SYSTEM->RegReset2.SDIOH1_SFT_RST = 1)
...
#define __SYSTEM_SDIOH1_DAT_SWAP_ENABLE()               (SYSTEM->SDIOH_Misc.SDIOH1_DAT_SWAP = 1)
#define __SYSTEM_SDIOH1_DAT_SWAP_DISABLE()              (SYSTEM->SDIOH_Misc.SDIOH1_DAT_SWAP = 0)
...
/* ======================================================================================================= */
/* =============================== BLEND Clock Select/Enable/Disable/Reset =============================== */
/* ======================================================================================================= */
#define __SYSTEM_BLEND_CLK_SELECT_COREH()               (SYSTEM->ClockSEL0.BLEND_CLK_SEL = 0)
#define __SYSTEM_BLEND_CLK_SELECT_SPLL()                (SYSTEM->ClockSEL0.BLEND_CLK_SEL = 1)

#define __SYSTEM_BLEND_CLK_DIV(__CLKDIV__)              (SYSTEM->BlockClockDIV2.BLEND_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_BLEND_CLK_ENABLE()                     (SYSTEM->ClockEnable7.BLEND_CLKEN = 1)
#define __SYSTEM_BLEND_CLK_DISABLE()                    (SYSTEM->ClockEnable7.BLEND_CLKEN = 0)

#define __SYSTEM_BLEND_RESET()                          (SYSTEM->RegReset7.BLEND_SFT_RST = 1)
...
/* ======================================================================================================= */
/* =============================== FFT Clock Select/Enable/Disable/Reset ================================= */
/* ======================================================================================================= */
#define __SYSTEM_FFT_CLK_SELECT_COREH()                 (SYSTEM->ClockSEL0.FFT_CLK_SEL = 0)
#define __SYSTEM_FFT_CLK_SELECT_SPLL()                  (SYSTEM->ClockSEL0.FFT_CLK_SEL = 1)

#define __SYSTEM_FFT_CLK_DIV(__CLKDIV__)                (SYSTEM->BlockClockDIV1.FFT_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_FFT_CLK_ENABLE()                       (SYSTEM->ClockEnable7.FFT_CLKEN = 1)
#define __SYSTEM_FFT_CLK_DISABLE()                      (SYSTEM->ClockEnable7.FFT_CLKEN = 0)

#define __SYSTEM_FFT_RESET()                            (SYSTEM->RegReset7.FFT_SFT_RST = 1)

/* ======================================================================================================= */
/* =============================== IIRFLT Clock Select/Enable/Disable/Reset =========================== == */
/* ======================================================================================================= */
#define __SYSTEM_IIRFLT_CLK_SELECT_COREH()              (SYSTEM->ClockSEL0.IIRFLT_CLK_SEL = 0)
#define __SYSTEM_IIRFLT_CLK_SELECT_SPLL()               (SYSTEM->ClockSEL0.IIRFLT_CLK_SEL = 1)

#define __SYSTEM_IIRFLT_CLK_DIV(__CLKDIV__)             (SYSTEM->BlockClockDIV1.IIRFLT_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_IIRFLT_CLK_ENABLE()                    (SYSTEM->ClockEnable7.IIRFLT_CLKEN  = 1)
#define __SYSTEM_IIRFLT_CLK_DISABLE()                   (SYSTEM->ClockEnable7.IIRFLT_CLKEN  = 0)

#define __SYSTEM_IIRFLT_RESET()                         (SYSTEM->RegReset7.IIRFLT_SFT_RST = 1)
...
#define __SYSTEM_I2C4_CLK_ENABLE()                      (SYSTEM->ClockEnable5.I2C4_CLKEN = 1)
#define __SYSTEM_I2C5_CLK_ENABLE()                      (SYSTEM->ClockEnable5.I2C5_CLKEN = 1)
...
#define __SYSTEM_I2C4_CLK_DISABLE()                     (SYSTEM->ClockEnable5.I2C4_CLKEN = 0)
#define __SYSTEM_I2C5_CLK_DISABLE()                     (SYSTEM->ClockEnable5.I2C5_CLKEN = 0)
...
#define __SYSTEM_I2C4_RESET()                           (SYSTEM->RegReset5.I2C4_SFT_RST = 1)
#define __SYSTEM_I2C5_RESET()                           (SYSTEM->RegReset5.I2C5_SFT_RST = 1)
...
#define __SYSTEM_SPI_MASTER2_CLK_ENABLE()               (SYSTEM->ClockEnable6.SSIM2_CLKEN = 1)
...
#define __SYSTEM_SPI_MASTER2_CLK_DISABLE()              (SYSTEM->ClockEnable6.SSIM2_CLKEN = 0)
...
#define __SYSTEM_SPI_MASTER2_RESET()                    (SYSTEM->RegReset6.SSIM2_SFT_RST = 1)
...
/* It is a RTL bug, both UART2 and UART3 clock should be enabled for UART3 */
...
#define __SYSTEM_GPIOA_RESET()                          (SYSTEM->RegReset4.GPIOA_SFT_RST = 1)
#define __SYSTEM_GPIOB_RESET()                          (SYSTEM->RegReset4.GPIOB_SFT_RST = 1)
#define __SYSTEM_GPIOC_RESET()                          (SYSTEM->RegReset4.GPIOC_SFT_RST = 1)
#define __SYSTEM_GPIOD_RESET()                          (SYSTEM->RegReset4.GPIOD_SFT_RST = 1)

/* ======================================================================================================== */
/* =============================== PWM Clock Enable/Disable/Reset ========================================= */
/* ======================================================================================================== */
...
/* ======================================================================================================= */
/* =============================== SBC Clock Select/Enable/Disable/Reset ================================= */
/* ======================================================================================================= */

#define __SYSTEM_SBC_CLK_SELECT_COREH()                 (SYSTEM->ClockSEL1.SBC_CLK_SEL = 0)
#define __SYSTEM_SBC_CLK_SELECT_SPLL()                  (SYSTEM->ClockSEL1.SBC_CLK_SEL = 1)

#define __SYSTEM_SBC_CLK_DIV(__CLKDIV__)                (SYSTEM->AudioClockDIV.SBC_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_SBCDEC_CLK_ENABLE()                    (SYSTEM->ClockEnable8.SBCDEC_CLKEN  = 1)
#define __SYSTEM_SBCENC_CLK_ENABLE()                    (SYSTEM->ClockEnable8.SBCENC_HCLKEN = 1)

#define __SYSTEM_SBCDEC_CLK_DISABLE()                   (SYSTEM->ClockEnable8.SBCDEC_CLKEN  = 0)
#define __SYSTEM_SBCENC_CLK_DISABLE()                   (SYSTEM->ClockEnable8.SBCENC_HCLKEN = 0)

#define __SYSTEM_SBCDEC_RESET()                         (SYSTEM->RegReset8.SBCDEC_SFT_RST = 1)
#define __SYSTEM_SBCENC_RESET()                         (SYSTEM->RegReset8.SBCENC_SFT_RST = 1)

/* ======================================================================================================= */
/* =============================== CODEC Clock Enable/Disable/Reset ====================================== */
/* ======================================================================================================= */
#define __SYSTEM_CODEC_CLK_ENABLE()                     (SYSTEM->ClockEnable8.CODEC_CLKEN = 1)
#define __SYSTEM_CODEC_CLK_DISABLE()                    (SYSTEM->ClockEnable8.CODEC_CLKEN = 0)

#define __SYSTEM_CODEC_RESET()                          (SYSTEM->RegReset8.CODEC_SFT_RST  = 1)
...
#define __SYSTEM_PDM2_CLK_SELECT_COREH()                (SYSTEM->ClockSEL1.PDM2_CLK_SEL = 0)
#define __SYSTEM_PDM2_CLK_SELECT_AUPLL()                (SYSTEM->ClockSEL1.PDM2_CLK_SEL = 1)
#define __SYSTEM_PDM2_CLK_SELECT_EXTERNAL()             (SYSTEM->ClockSEL1.PDM2_CLK_SEL = 2)
...
#define __SYSTEM_PDM2_CLK_DIV(__CLKDIV__)               (SYSTEM->AudioClockDIV.PDM2_CLK_DIV = __CLKDIV__ - 1)
...
#define __SYSTEM_PDM2_CLK_ENABLE()                      (SYSTEM->ClockEnable8.PDM2_CLKEN = 1)
...
#define __SYSTEM_PDM2_CLK_DISABLE()                     (SYSTEM->ClockEnable8.PDM2_CLKEN = 0)

#define __SYSTEM_PDM0_RESET()                           (SYSTEM->RegReset8.PDM0_SFT_RST = 1)
#define __SYSTEM_PDM1_RESET()                           (SYSTEM->RegReset8.PDM1_SFT_RST = 1)
#define __SYSTEM_PDM2_RESET()                           (SYSTEM->RegReset8.PDM2_SFT_RST = 1)
...
/* ====================================================================================================== */
/* =============================== USB Clock Select/Enable/Disable/Reset ================================ */
/* ====================================================================================================== */
#define __SYSTEM_USB_CLK_SELECT_SPLL()                  (SYSTEM->ClockSEL0.USB_CLK_SEL = 0)
#define __SYSTEM_USB_CLK_SELECT_AUPLL()                 (SYSTEM->ClockSEL0.USB_CLK_SEL = 1)

#define __SYSTEM_USB_CLK_DIV(__CLKDIV__)                (SYSTEM->BlockClockDIV2.USB_CLK_DIV = __CLKDIV__ - 1)
...
/* ====================================================================================================== */
/* =============================== PARALLEL Select/Clock Enable/Disable/Reset =========================== */
/* ====================================================================================================== */
#define __SYSTEM_PARALLEL_CLK_SELECT_COREH()            (SYSTEM->ClockSEL0.PARALLEL_CLK_SEL = 0)
#define __SYSTEM_PARALLEL_CLK_SELECT_SPLL()             (SYSTEM->ClockSEL0.PARALLEL_CLK_SEL = 1)
#define __SYSTEM_PARALLEL_CLK_SELECT_AUPLL()            (SYSTEM->ClockSEL0.PARALLEL_CLK_SEL = 2)

#define __SYSTEM_PARALLEL_CLK_DIV(__CLKDIV__)           (SYSTEM->BlockClockDIV1.PARALLEL_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_PARALLEL_CLK_ENABLE()                  (SYSTEM->ClockEnable9.PARALLEL_CLKEN = 1)

#define __SYSTEM_PARALLEL_CLK_DISABLE()                 (SYSTEM->ClockEnable9.PARALLEL_CLKEN = 0)

#define __SYSTEM_PARALLEL_RESET()                       (SYSTEM->RegReset9.PARALLEL_SFT_RST = 1)

/* ====================================================================================================== */
/* =============================== TRIGFUNC Select/Clock Enable/Disable/Reset =========================== */
/* ====================================================================================================== */
#define __SYSTEM_TRIGFUNC_CLK_SELECT_COREH()            (SYSTEM->ClockSEL0.TRIGFUNC_CLK_SEL = 0)
#define __SYSTEM_TRIGFUNC_CLK_SELECT_SPLL()             (SYSTEM->ClockSEL0.TRIGFUNC_CLK_SEL = 1)

#define __SYSTEM_TRIGFUNC_CLK_DIV(__CLKDIV__)           (SYSTEM->BlockClockDIV1.TRIGFUNC_CLK_DIV = __CLKDIV__ - 1)

#define __SYSTEM_TRIGFUNC_CLK_ENABLE()                  (SYSTEM->ClockEnable7.TRIGFUNC_CLKEN = 1)

#define __SYSTEM_TRIGFUNC_CLK_DISABLE()                 (SYSTEM->ClockEnable7.TRIGFUNC_CLKEN = 0)

#define __SYSTEM_TRIGFUNC_RESET()                       (SYSTEM->RegReset7.TRIGFUNC_SFT_RST = 1)
...
#define __SYSTEM_FR3068E_QSPI0_IO2_IO3_CONFIG()         do { __SYSTEM_QSPI0_PAD5_USED_IO3();   \
                                                             __SYSTEM_QSPI0_PAD8_USED_IO2();   \
                                                             __SYSTEM_QSPI0_PAD4_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD6_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD7_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD9_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD_PULL_DISABLE(SYSTEM_QSPI0_PAD0|SYSTEM_QSPI0_PAD2|SYSTEM_QSPI0_PAD3|SYSTEM_QSPI0_PAD5|SYSTEM_QSPI0_PAD8); \
                                                             __SYSTEM_QSPI0_PAD_PULL_ENABLE(SYSTEM_QSPI0_PAD4|SYSTEM_QSPI0_PAD6|SYSTEM_QSPI0_PAD7|SYSTEM_QSPI0_PAD9); \
                                                             __SYSTEM_QSPI0_PAD_PULL_SEL_DOWN(SYSTEM_QSPI0_PAD4|SYSTEM_QSPI0_PAD6|SYSTEM_QSPI0_PAD7|SYSTEM_QSPI0_PAD9); \
                                                        } while(0)

#define __SYSTEM_FR3092E_QSPI0_IO2_IO3_CONFIG()         do { __SYSTEM_QSPI0_PAD4_USED_IO2();   \
                                                             __SYSTEM_QSPI0_PAD5_USED_IO3();   \
                                                             __SYSTEM_QSPI0_PAD0_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD1_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD8_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD9_USED_REGIO(); \
                                                             __SYSTEM_QSPI0_PAD_PULL_DISABLE(SYSTEM_QSPI0_PAD2|SYSTEM_QSPI0_PAD3|SYSTEM_QSPI0_PAD4|SYSTEM_QSPI0_PAD5|SYSTEM_QSPI0_PAD6); \
                                                             __SYSTEM_QSPI0_PAD_PULL_ENABLE(SYSTEM_QSPI0_PAD0|SYSTEM_QSPI0_PAD1|SYSTEM_QSPI0_PAD8|SYSTEM_QSPI0_PAD9); \
                                                             __SYSTEM_QSPI0_PAD_PULL_SEL_DOWN(SYSTEM_QSPI0_PAD0|SYSTEM_QSPI0_PAD1|SYSTEM_QSPI0_PAD8|SYSTEM_QSPI0_PAD9); \
                                                        } while(0)
