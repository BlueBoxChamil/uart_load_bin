...
#define PMU_RAM_RET_SRAM0_BIT       (1<<5)  // 64K, 0x20000000~0x2000ffff
#define PMU_RAM_RET_SRAM1_BIT       (1<<6)  // 64K, 0x20010000~0x2001ffff
#define PMU_RAM_RET_SRAM2_BIT       (1<<7)  // 128K, 0x20020000~0x2003ffff
#define PMU_RAM_RET_SRAM3_BIT       (1<<8)  // 128K, 0x20040000~0x2005ffff
#define PMU_RAM_RET_SRAM4_BIT       (1<<9)  // 128K, 0x20060000~0x2007ffff
#define PMU_RAM_RET_SRAM5_BIT       (1<<10) // 128K, 0x20080000~0x2009ffff
#define PMU_RAM_RET_SRAM6_BIT       (1<<11) // 128K, 0x200a0000~0x200bffff
#define PMU_RAM_RET_DRAM_BIT        (1<<12) // 256K, 0x200c0000~0x200fffff
#define PMU_RAM_RET_IRAM_BIT        (1<<13) // 128K, 0x1ffc0000~0x1ffdffff
