...
typedef enum
{
    ...
    OUTPUT_ROUTING_DACFFLR_DACFF01_GPF1_DRC_ASRC1 = 4,    /* DACFIFO_LR & DACFIFO_01 -> GPF1 -> DRC -> ASRC1 -> OUT */
...
#define CODEC_ANALOG1_CFG    (0x47528100)
#define CODEC_ANALOG2_CFG    (0x800F3FCF)
...
/* GPF section enable selection */
#define __CODEC_GPF_SECTION_ENABLE(__SEL__, __ENABLE__)         (CODEC->GPF[__SEL__].SectionEn.EN = __ENABLE__)
