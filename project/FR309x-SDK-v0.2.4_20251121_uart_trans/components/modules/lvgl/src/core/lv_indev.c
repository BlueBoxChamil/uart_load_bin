...
void lv_indev_set_obj_act(lv_obj_t *obj)
{
    indev_obj_act = obj;
}
...
static void indev_proc_press(_lv_indev_proc_t * proc)
{
    ...
    proc->types.pointer.scroll_throw_vect.x += proc->types.pointer.vect.x;
    proc->types.pointer.scroll_throw_vect.y +=proc->types.pointer.vect.y;
    #endif
