 ...
 */
LV_IMG_FAST_MEM lv_disp_t * lv_disp_get_default(void)
{
    return disp_def;
}
 ...
 */
LV_IMG_FAST_MEM lv_coord_t lv_disp_get_hor_res(lv_disp_t * disp)
{
 ...
 */
LV_IMG_FAST_MEM lv_coord_t lv_disp_get_ver_res(lv_disp_t * disp)
{
    if(disp == NULL) disp = lv_disp_get_default();
